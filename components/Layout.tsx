  ...
  return (
    <div className="layout-container">
      <Head>
        ...
        <meta property="og:description" content={stripHtml(meta.excerpt ? meta.excerpt.rendered : `${meta.preacher[0].name} | ${meta.sermon_series[0].name}`)} />
        <meta
          property="og:image"
          content={meta && meta.better_featured_image && meta.better_featured_image.media_details ? meta.better_featured_image.media_details.sizes.medium.source_url : meta.featured_image.large}
        />
        <meta property="og:url" content={router.pathname === '/sermons/[sermon]' ? `https://hillcitysc.com/sermons/${router.query.sermon}` : `https://hillcitysc.com${router.pathname}`} />
        ...
        <meta name="twitter:description" content={stripHtml(meta.excerpt ? meta.excerpt.rendered : `${meta.preacher[0].name} | ${meta.sermon_series[0].name}`)} />
        <meta
          name="twitter:image"
          content={meta && meta.better_featured_image && meta.better_featured_image.media_details ? meta.better_featured_image.media_details.sizes.medium.source_url : meta.featured_image.large}
        />
        <meta name="twitter:card" content={router.pathname === '/sermons/[sermon]' ? `https://hillcitysc.com/sermons/${router.query.sermon}` : `https://hillcitysc.com${router.pathname}`} />
          ...
          <Container>
            ...
            <Navbar.Collapse className="justify-content-end">
              <Navbar.Text>
                    ...
                    overlay={
                      <Popover id={`popover-positioned-${'bottom'}`} className="font-adajust-popover">
                        <Popover.Body>
                          ...
                          <HexColorPicker color={fontColor} onChange={(e: any) => setLiveStreamPageStyles({ ...liveStreamPageStyles, color: e })} />
                          <div className="screen-mode-container">
                            ...
                            <div className="light-mode-icon" onClick={() => setLiveStreamPageStyles({ ...liveStreamPageStyles, background: '' })}>
                ...
                <i className="fa-brands fa-facebook" style={fontIconColor} onClick={() => window.open('https://www.facebook.com/hillcitysc')}></i>
        ...
        <div className="footer-content-container">
          <div>
            ...
            <div style={{ marginTop: '-40px' }}>
              <i className="fa-brands fa-youtube" style={{ color: '#ffffff' }} onClick={() => window.open('https://www.youtube.com/@hillcitychurch7087/streams')}></i>
              <i className="fa-brands fa-facebook" style={{ color: '#ffffff' }} onClick={() => window.open('https://www.facebook.com/hillcitysc')}></i>
            </div>
          </div>
          <div>
            <h1>Map</h1>
      ...
      <Modal show={showAnnouncementModal} onHide={() => setShowAnnouncementModal(false)}>
        ...
        <Modal.Body>{data && data.special_announcement ? <div className="p-2" dangerouslySetInnerHTML={{ __html: data.special_announcement }} /> : null}</Modal.Body>
      </Modal>
    </div>
  );
}
